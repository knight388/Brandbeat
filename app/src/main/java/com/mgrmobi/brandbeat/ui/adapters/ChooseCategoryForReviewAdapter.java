 ...
 */
public class ChooseCategoryForReviewAdapter extends RecyclerView.Adapter<ChooseCategoryForReviewAdapter.ViewHolder> {
    ...
    public ChooseCategoryForReviewAdapter(ArrayList<ResponseCategories> intersts, Context context, Fragment fragment) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.icon.setOnClickListener(v -> {
            ...
            context.startActivity(SubCategoryActivity.createIntent(context, inter.getId(), inter.getName(), mass[0], mass[1]));
        });
    }
