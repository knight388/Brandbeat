...
import com.mgrmobi.brandbeat.ui.adapters.ChooseCategoryForCompareAdapter;
 ...
 */
public class ChooseCategoryForCampareFragment extends Fragment {
    private RecyclerView gridView;
    private PresenterInterestsView presenter = new PresenterInterestsView();
    private ContainerInterests containerInterests;
    private ChooseCategoryForCompareAdapter interestsAdapter;
    ...
    private void initGrid(ArrayList<ResponseCategories> interestses) {
        ...
        interestsAdapter = new ChooseCategoryForCompareAdapter(interestses, getContext());
