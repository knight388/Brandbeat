...
public class WriteReviewAdapter extends RecyclerView.Adapter<WriteReviewAdapter.ViewHolder> {
    ...
    public WriteReviewAdapter(Context context, List<String> responsePhotoUrls, List<Bitmap> bitmaps, ClickImageRecyclerPhoto clickImageRecyclerPhoto, ResponseReview responseReview, ResponseLocalFeed responseLocalFeed) {
    ...
    public WriteReviewAdapter(Context context, List<String> responsePhotoUrls, List<Bitmap> bitmaps, ClickImageRecyclerPhoto clickImageRecyclerPhoto, ResponseReview responseReview) {
        this.bitmaps = bitmaps;
        this.clickImageRecyclerPhoto = clickImageRecyclerPhoto;
        this.responsePhotoUrls = responsePhotoUrls;
        this.responseReview = responseReview;
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.write_review_item, parent, false);
