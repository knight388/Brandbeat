...
import com.mgrmobi.brandbeat.ui.adapters.best_ui.NewSubCategoryAdapter;
 ...
 */
public class NewCheckSubCategoryFragment extends Fragment implements FollowInbrandCallBack {
    private RecyclerView gridView;
    private PresenterSubCategory presenter = new PresenterSubCategory();
    private ContainerSubCategory containerSubCategory;
    private NewSubCategoryAdapter interestsAdapter;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        presenter.getSubCategory((String) getActivity().getIntent().getSerializableExtra(CheckedSubCategoryActivity.CATEGORY_ID));
    ...
    private void initGrid(ArrayList<ResponseCategories> interestses) {
        ...
        interestsAdapter = new NewSubCategoryAdapter(getActivity(), (ArrayList<ResponseCategories>) responseCategoriesList, this);
    ...
    public void unFollowBrand(final String id) {
        presenter.unFollowBrand(id);
    }

    @Override
    public void followBrand(final String id) {
        presenter.followBrand(id);
    }
}
