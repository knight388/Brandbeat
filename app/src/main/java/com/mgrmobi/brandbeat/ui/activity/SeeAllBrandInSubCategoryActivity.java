 ...
 */
public class SeeAllBrandInSubCategoryActivity extends BaseActivity implements ContainerRecentBrands {
    ...
    public static Intent createIntent(Context context, String subcat, String name) {
        Intent intent = new Intent(context, SeeAllBrandInSubCategoryActivity.class);
    ...
    private void showFragment() {
        fragment = new SeeAllBrandInSubCategoryFragment();
        super.showFragment(fragment);
    }

    @Override
    public void getBrands(final ArrayList<ResponseBrand> responseBrands) {
        if (fragment instanceof SeeAllBrandInSubCategoryFragment) {
            ((SeeAllBrandInSubCategoryFragment) fragment).setBrands(responseBrands);
        }
    }
