...
import pl.charmas.android.reactivelocation.observables.geocode.ReverseGeocodeGoogleApiObservable;
...
import pl.charmas.android.reactivelocation.observables.location.*;
...
public class ReactiveLocationProvider {
    ...
    /**
     * Creates observable that translates latitude and longitude to list of possible addresses using
     * included GoogleApi. You should subscribe for this observable on I/O thread.
     * The stream finishes after address list is available.
     *
     * @param lat          latitude
     * @param lon          longitude
     ...
     * @return observable that serves list of address based on location
     */
    public Observable<GoogleAddress> getReverseGeocodeGoogleApiObservable(double lat, double lon, String googleApiKey) {
        return ReverseGeocodeGoogleApiObservable.createObservable(ctx, lat, lon, googleApiKey);
    }
     ...
     * @return observable that serves list of address based on location
     */
    public Observable<GoogleAddress> getReverseGeocodeGoogleApiObservable(LatLng latLng, String googleApiKey) {
        return ReverseGeocodeGoogleApiObservable.createObservable(ctx, latLng.latitude, latLng.longitude, googleApiKey);
    }
     ...
     * @return observable that serves list of address based on location
     */
    public Observable<GoogleAddress> getReverseGeocodeGoogleApiObservable(Location location, String googleApiKey) {
        return ReverseGeocodeGoogleApiObservable.createObservable(ctx, location.getLatitude(), location.getLongitude(), googleApiKey);
    }
